...
SessionLocal = sessionmaker(autocommit=False, autoflush=False, bind=engine) # creamos una clase de sesión utilizando sessionmaker, configuramos autocommit y autoflush en False y vinculamos el motor de base de datos

Base = declarative_base() # creamos una clase base para nuestros modelos de base de datos utilizando declarative_base, esto nos permite definir nuestras tablas como clases de Python
